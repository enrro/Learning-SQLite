package com.example.edgar.class3friday;
...
public class MainActivity extends AppCompatActivity {
    ...
    // (remote storage)
    // -SQLite lightweight DBMs, barebones QLS db, relational
    ...
    public void delete(View v){
        Toast.makeText(this, "DELETE " + db.delete(editText.getText().toString()), Toast.LENGTH_SHORT).show();
